...
import GeneralConfig from '@/v1/components/GeneralConfig.vue'
import PricesConfig from '@/v1/components/PricesConfig.vue'
import BuildingTypeModal from '@/v1/components/BuildingTypeModal.vue'
import BuildingsList from '@/v1/components/BuildingsList.vue'
import ConsumptionSummary from '@/v1/components/ConsumptionSummary.vue'
import ProductionSummary from '@/v1/components/ProductionSummary.vue'
import WorkerConsumption from '@/v1/components/WorkerConsumption.vue'
import NetBalance from '@/v1/components/NetBalance.vue'
import EconomicSummary from '@/v1/components/EconomicSummary.vue'
import { GAME_DATA } from './data'
import { WORKER_CONFIG } from '@/v1/config/constants'
import { loadData, saveData } from '@/v1/utils/storage/localStorageManager'
import { useCalculations } from '@/v1/composables/useCalculations'
