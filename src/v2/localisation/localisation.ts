...
const messages: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    perDay: 'per day',
    workers: 'Workers',
    activeUnits: 'Active modules',
    queueShare: 'Queue share',
    cyclesPerUnit: 'Cycles per unit',
  ...
  de: {
    ...
    perDay: 'pro Tag',
    workers: 'Arbeiter',
    activeUnits: 'Aktive Stufen',
    queueShare: 'Zeitanteil',
    cyclesPerUnit: 'Durchläufe je Stufe',
    runsPerDay: 'Durchgänge pro Tag',
