...
const messages: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    perDay: 'per day',
    workers: 'Workers',
    shareLabel: 'Utilisation',
    availableCapacity: 'Available capacity',
    requestedShare: 'Requested share',
    effectiveShare: 'Active share',
    outputPerDay: 'Output per day',
    inputsPerDay: 'Inputs',
    cycleTime: 'Cycle time',
    minutes: 'minutes',
    overCapacityShare: 'Capacity or housing shortfall – adjust utilisation or add housing.',
  ...
  de: {
    ...
    perDay: 'pro Tag',
    workers: 'Arbeiter',
    shareLabel: 'Nutzungsanteil',
    availableCapacity: 'Verfügbare Kapazität',
    requestedShare: 'Zugewiesener Anteil',
    effectiveShare: 'Aktiv genutzt',
    outputPerDay: 'Ausstoß pro Tag',
    inputsPerDay: 'Input',
    cycleTime: 'Zykluszeit',
    minutes: 'Minuten',
    overCapacityShare: 'Kapazität oder Wohnraum fehlen – Nutzung anpassen oder Wohnraum schaffen.',
