...
const DEFAULT_CATEGORY: MaterialCategory = {
  id: 0,
  name: 'Unknown',
...
export function getCategoryByType(type?: number): MaterialCategory {
  return MATERIAL_CATEGORIES.find((c) => c.id === type) ?? DEFAULT_CATEGORY
}
