...
import { technologyCostsRepository } from '@/v2/services/technologyCosts/technologyCosts.service'
...
describe('Technology Costs - User Verified Wiki Values', () => {
  ...
  it('should return 98 research data for level 0->1 (TotalTech=29)', async () => {
    ...
    const cost = technologyCostsRepository.computeTechnologyResearchCost(1, 0, 1, gameData, TOTAL_TECH)
  ...
  it('should return 116 research data for level 1->2 (TotalTech=29)', async () => {
    const { data: gameData } = await loadGameData(true)
    const cost = technologyCostsRepository.computeTechnologyResearchCost(1, 1, 2, gameData, TOTAL_TECH)
  ...
  it('should return 180 research data for level 3->4 (TotalTech=29)', async () => {
    const { data: gameData } = await loadGameData(true)
    const cost = technologyCostsRepository.computeTechnologyResearchCost(1, 3, 4, gameData, TOTAL_TECH)
  ...
  it('should return 199 research data + 35 advanced research data for level 5->6 (TotalTech=29)', async () => {
    const { data: gameData } = await loadGameData(true)
    const cost = technologyCostsRepository.computeTechnologyResearchCost(1, 5, 6, gameData, TOTAL_TECH)
  ...
  it('should return 219 advanced research data + 86 apex research data for level 11->12 (TotalTech=29)', async () => {
    const { data: gameData } = await loadGameData(true)
    const cost = technologyCostsRepository.computeTechnologyResearchCost(1, 11, 12, gameData, TOTAL_TECH)
  ...
  it('should show all levels to diagnose the issue (TotalTech=29)', async () => {
    ...
    for (let level = 0; level <= 10; level++) {
      const cost = technologyCostsRepository.computeTechnologyResearchCost(1, level, level + 1, gameData, TOTAL_TECH)
